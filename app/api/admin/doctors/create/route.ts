      ...
      data: {
        ...
        doctorProfile: {
          create: {
            ...
            tcKimlikNo: validatedData.tcKimlikNo
              ? encryptTcKimlik(validatedData.tcKimlikNo)
              : null,
            tcKimlikNoHash: validatedData.tcKimlikNo
              ? hashTcKimlik(validatedData.tcKimlikNo)
              : null,
