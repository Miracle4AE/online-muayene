...
export default function DoctorDashboardPage() {
  ...
  const fetchTodayAppointments = async () => {
    ...
    try {
      ...
      console.error("✅ State değeri:", todayAppointments.length, "->", newAppointments.length);
    } catch (err: any) {
  ...
  const handleSendReply = async (messageId: string) => {
    ...
    if (!replyText) {
      showError("Lütfen mesajınızı yazın");
      return;
    }
    ...
    try {
      ...
      showError(err.message || "Mesaj gönderilirken bir hata oluştu");
    } finally {
                                ...
                                >
                                  <div className="flex items-center justify-between mb-2">
                                    <span className="text-sm font-semibold text-gray-700">
                                      {reply.senderRole === "DOCTOR" ? "Sizin Yanıtınız" : "Hasta Yanıtı"}
                                    </span>
                          ...
                          {message.status === "ACTIVE" && (
                            <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4">
                              ...
                              <div className="mt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                <div className="flex items-center gap-2">
                                  <label className="inline-flex items-center gap-2 px-3 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 cursor-pointer hover:bg-gray-50">
